	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for(int i=0;i<5;i++)
		{
			...
			case 4:
			{
				...
				glBindTexture(GL_TEXTURE_2D, bkg);
				break;
			}
			case 3:
			{
			...
			case 1:
			{
				...
				colorShader.setVec3("objectColor", 0.5f, 0.31f, 1.0f);
				colorShader.setVec3("material.ambient", 0.5f, 0.31f, 1.0f);
				colorShader.setVec3("material.diffuse", 0.5f, 0.31f, 1.0f);
				colorShader.setVec3("material.specular", 0.7f, 0.7f, 0.7f);
				glBindVertexArray(cubeVAO);
			}
			case 0:
			{
